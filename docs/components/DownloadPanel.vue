        ...
        groups: [
            {
                ...
                assets: [
                    {
                        kind: 'APK',
                        name: 'PacBao_1.0.1.apk',
                        size: '',
                        url: 'https://files.pacbao.com/pacbao/PacBao_1.0.1.apk',
                        titleSuffix: 'APK',
                    },
                ],
            },
            ...
            <div class="dl-recommend-actions">
                <template v-if="recommendedAsset?.url">
                    ...
                    <a
                        ...
                        :href="
                            proxyUrl(recommendedAsset.url, 'v6.gh-proxy.org')
                        "
                        target="_blank"
                        rel="noreferrer"
                    >
                    ...
                    <ul class="dl-list">
                        <li v-for="asset in group.assets" :key="asset.name">
                            ...
                            <div v-else class="dl-row is-disabled">
                                ...
                                <div class="dl-row-meta">
                                    <span class="dl-row-cta is-muted">{{
                                        t.comingSoon
                                    }}</span>
                                </div>
                            </div>
